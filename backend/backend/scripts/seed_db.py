...
from models.project import Product, Class
from services.auth.rbac import hash_password
...
def seed_data():
    ...
    try:
        ...
        print("\n📦 Sample data:")
        print("   - 2 Products (Electronics PCB, Textile Fabric)")
        print("   - 7 Defect Classes")
